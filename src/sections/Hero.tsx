...
export const Hero = () => {
  return (
    ...
    >
      ...
      {/* Start Ring 1 */}
      <div className="absolute size-[344px] md:size-[580px] opacity-20 border border-white rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      {/* End Ring 1 */}
      {/* Start Ring 2 */}
      <div className="absolute size-[444px] md:size-[780px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed" />
      {/* End Ring 2 */}
      {/* Start Ring 3 */}
